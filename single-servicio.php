...
if(!empty($pagename)){ ?>
 <?php while(have_posts()){ the_post();?>
         <div class="container sin-padding">
                    ...
                    <div class="aduanas-n sin-padding   col-lg-6  col-md-6 col-sm-12  col-xs-12" style="background: url(<?php the_field('background_left'); ?>)   top center no-repeat; backgroun-size:cover;">
                        <?php } ?>
